 ...
 * the {@link AlignToTag14FieldRelativePose3D} which drives to a field location coordinate.
 * <p>
...
public class AlignToPairedTagTargetRelativeTransform3D extends Command {
    ...
    public AlignToPairedTagTargetRelativeTransform3D(VisionContainer visionContainer, Drivetrain drivetrain) {
        ...
        // They can be seen at robot heading of 0 - the fake gyro heading
        ...
        tagIDsPossible.put(3, new Transform3d(1., -0.17, 0., new Rotation3d(0., 0., Math.PI))); // left (odd)
        tagIDsPossible.put(4, new Transform3d(1., 0.0, 0., new Rotation3d(0., 0., Math.PI))); // right (even)

        tagIDsPossible.put(9, new Transform3d(1., -0.17, 0., new Rotation3d(0., 0., Math.PI)));
        tagIDsPossible.put(10, new Transform3d(1., 0.0, 0., new Rotation3d(0., 0., Math.PI)));

        tagIDsPossible.put(13, new Transform3d(1., -0.17, 0., new Rotation3d(0., 0., Math.PI)));
        tagIDsPossible.put(14, new Transform3d(1., 0.0, 0., new Rotation3d(0., 0., Math.PI)));

        tagIDsPossible.put(15, new Transform3d(1., -0.17, 0., new Rotation3d(0., 0., Math.PI)));
        tagIDsPossible.put(16, new Transform3d(1., 0.0, 0., new Rotation3d(0., 0., Math.PI)));

        tagIDsPossible.put(19, new Transform3d(1., -0.17, 0., new Rotation3d(0., 0., Math.PI)));
        tagIDsPossible.put(20, new Transform3d(1., 0.0, 0., new Rotation3d(0., 0., Math.PI)));

        tagIDsPossible.put(25, new Transform3d(1., -0.17, 0., new Rotation3d(0., 0., Math.PI)));
        tagIDsPossible.put(26, new Transform3d(1., 0.0, 0., new Rotation3d(0., 0., Math.PI)));

        tagIDsPossible.put(29, new Transform3d(1., -0.17, 0., new Rotation3d(0., 0., Math.PI)));
        tagIDsPossible.put(30, new Transform3d(1., 0.0, 0., new Rotation3d(0., 0., Math.PI)));

        tagIDsPossible.put(31, new Transform3d(1., -0.17, 0., new Rotation3d(0., 0., Math.PI)));
