...
public class RobotContainer  {
    ...
    private void configureBindings() {
        ...
        AlignToTag14FieldRelativePose3D(driverController);
        AlignToTag14RelativeArcade2D(driverController);
     ...
     */
    private static void AlignToTag14FieldRelativePose3D(CommandXboxController controller) {
        Trigger aButton = controller.a();
        if (getVisionContainer().vision()) {
            aButton.whileTrue(new AlignToTag14FieldRelativePose3D(getVisionContainer(), getDrivetrain()));
        } else {
     ...
     */
    private static void AlignToTag14RelativeArcade2D(CommandXboxController controller) {
        Trigger bButton = controller.b();
        if (getVisionContainer().vision()) {
            bButton.whileTrue(new AlignToTag14RelativeArcade2D(getVisionContainer(), getDrivetrain()));
        } else {
